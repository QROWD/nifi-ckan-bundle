...
import org.aksw.ckan.processors.ckan.pojos.ResourceResponse;
...
public class CkanApiHandler {
    private final Logger log = Logger.getLogger(CkanApiHandler.class);
    ...
    CkanApiHandler(String HOST, String api_key, String filename, String organization_id, String package_description, Boolean package_private) {
        this.HOST = HOST;
